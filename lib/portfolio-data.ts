export const portfolio = {
  ...
  internships: [['AI ML INTERN - 3SKILL', '3skill', 'June 2026 – July 2026', 'A community development initiative focused on creating awareness about cyber threats, online scams, data privacy, and safe internet practices. The project encouraged responsible digital behaviour and helped participants learn essential cybersecurity measures to stay safe online.', 'Gaining hands-on experience in Artificial Intelligence and Machine Learning through Python, data preprocessing, data analysis, machine learning models, and practical projects. Working with real-world datasets to develop and evaluate AI/ML solutions.']],
